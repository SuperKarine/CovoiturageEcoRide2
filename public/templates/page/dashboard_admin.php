        ...
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <a href="/chauffeur/dashboard" class="btn btn-primary">Acceder</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <a href="/passager/dashboard" class="btn btn-success">Acceder</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <a href="/admin/trajets" class="btn btn-warning">Gerer les trajets</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2 d-md-flex">
                        <a href="/chauffeur/proposer-trajet" class="btn btn-success me-2">
                            Creer un trajet
                        </a>
                        <a href="/admin/trajets" class="btn btn-primary me-2">
                            Modifier des trajets
                        </a>
                        <a href="/passager/reservations" class="btn btn-info me-2">
                            Voir les reservations
                        </a>
                        <a href="/trajets-disponibles" class="btn btn-secondary">
